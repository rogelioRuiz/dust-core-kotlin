...
/**
 * Creates [ModelSession] instances on demand.
 *
 * Task libraries (LLM, ONNX, …) implement this interface so that
 * [dust-serve] can delegate session creation without knowing the
